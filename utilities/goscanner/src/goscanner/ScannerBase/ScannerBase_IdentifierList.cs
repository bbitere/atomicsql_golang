...
{
    public string NameIdentif { get; set; }    
    public TypeInfo TypeIdentif { get; set; }  
    public TIdentifier(string name, TypeInfo type)
    {
        this.NameIdentif = name;
        this.TypeIdentif = type;
    }
