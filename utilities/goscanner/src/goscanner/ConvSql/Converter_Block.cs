...
{
    private readonly Stack<TBlock> m_blocks = new();
    //private readonly Stack<TBlock> m_blocksMisc = new();
    ...
    private TBlock PushBlock()
    {
        var block = new TBlock(m_targetOutputFile, m_LambdaCode );
        m_blocks.Push( block);
