...
type DBTableNoSql[T IGeneric_MODEL] struct {
	//rows      []*T
	m_sqlName     string
	m_langName    string
...
func (_this *DBTableNoSql[T]) cloneTable_GenModel() *DBTableNoSql[IGeneric_MODEL] {

	var table = (new(DBTableNoSql[IGeneric_MODEL])).Constr(_this.m_sqlName, _this.m_langName, _this.m_ctx)
...
func (_this *DBTableNoSql[T]) CloneGenericModel() *DBTableNoSql[IGeneric_MODEL] {

	var newInst = new(DBTableNoSql[IGeneric_MODEL])
...
//
func (_this *DBTableNoSql[T]) QryS(tagID string, containerQuery IDBQuery) *DBQueryNoSql[T] {
