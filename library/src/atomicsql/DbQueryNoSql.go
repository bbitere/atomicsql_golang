...
type DBSqlQueryNoSql[T IGeneric_MODEL] struct {
	text string
	...
	m_listOperands []*DBSqlQueryNoSql[T]

	/*#PHPARG=[ Array<String> ];*/
	m_listOperandsStr []any
}

func (_this *DBSqlQueryNoSql[T]) Constr( /*#String*/ text string) *DBSqlQueryNoSql[T] {

	_this.text = text
	return _this
}

func (_this *DBSqlQueryNoSql[T]) cloneSqlQuery_GenModel() *DBSqlQueryNoSql[IGeneric_MODEL] {

	var newQ = (new(DBSqlQueryNoSql[IGeneric_MODEL])).Constr(_this.text)
...
/*#PHPARG=[ String ];*/
func (_this *DBSqlQueryNoSql[T]) getText() string {
	return _this.text
}
...
type DBQueryNoSql[T IGeneric_MODEL] struct {
	//DBSqlQueryNoSql[T]
	//rows []*T

	//tableName string;
	/*#PHPARG=[ DBSqlProvider<T> ];*/
	parentQuery IDBQuery //*DBQueryNoSql[T]
...
func (_this *DBQueryNoSql[T]) cloneQuery_GenModel() *DBQueryNoSql[IGeneric_MODEL] {

	var newTable = _this.tableInst.cloneTable_GenModel()
	var newQuery = (new(DBQueryNoSql[IGeneric_MODEL])).Constr(newTable) //_this.tableInst.m_DBSqlProvider );
...
func SelectN[T IGeneric_MODEL, V IGeneric_MODEL](
...
//
// **NOTE2**: pay attention: literal function fnSelect and sequence should be stacked in the Select() argument not placed outside
func SelectSubQN[T IGeneric_MODEL, V IGeneric_MODEL](
	sequence *DBQueryNoSql[T],
...
//
// **NOTE2**: pay attention: literal function fnSelect and sequence should be stacked in the Select() argument not placed outside
func AggregateNSql[T IGeneric_MODEL, V IGeneric_MODEL](
	...
	if _this.pRTM != nil {
		...
		var sql, excludeFromGroupBy = _Aggregate_generateSql_NoSql[T, V](_this, _this.m_SQL_ITEM_DEF)
...
//
// So, the second case it is a bit complex, we prefer the first one.
func (_this *DBQueryNoSql[T]) GetSingleDataInt(sqlResult *sql.Rows, fieldName string) (int64, error) {
...
func _SelectValue_queryNSql[T IGeneric_MODEL, V comparable](
	_this *DBQueryNoSql[T], fnSelect func(x *T) V, refDbResult1 **sql.Rows) (*DBQueryNoSql[TGetValueModel[V]], error) {

	return nil, nil
}

func (_this *DBQueryNoSql[T]) singleDataS(dbResult *sql.Rows, fieldName string) (string, error) {
...
func (_this *DBQueryNoSql[T]) singleDataInt(dbResult *sql.Rows, fieldName string) (int64, error) {
...
func (_this *DBQueryNoSql[T]) singleDataFloat(dbResult *sql.Rows, fieldName string) (float64, error) {
...
func (_this *DBQueryNoSql[T]) singleDataBool(dbResult *sql.Rows, fieldName string) (bool, error) {
...
// ----------------------------------------------------------------------------
func (_this *DBQueryNoSql[T]) _arrayOfSingleFieldString(sqlResult *sql.Rows, fieldName string) ([]string, error) {
...
// ----------------------------------------------------------------------------
func (_this *DBQueryNoSql[T]) _arrayOfSingleFieldInt(sqlResult *sql.Rows, fieldName string) ([]int64, error) {
...
// ----------------------------------------------------------------------------
func (_this *DBQueryNoSql[T]) _arrayOfSingleFieldFloat(sqlResult *sql.Rows, fieldName string) ([]float64, error) {
...
// ----------------------------------------------------------------------------
func (_this *DBQueryNoSql[T]) _arrayOfSingleFieldBool(sqlResult *sql.Rows, fieldName string) ([]bool, error) {
...
func _Aggregate_generateSql_NoSql[T IGeneric_MODEL, V IGeneric_MODEL](_this *DBQueryNoSql[T], ITEM string) (string, []string) {
