...
type DBTableNoSql[T atomicsql.IGeneric_MODEL] struct {
	//rows      []*T
	m_sqlName     string
	m_langName    string
	m_schemaTable string
	m_ctx         *DBContextBaseNoSql
	//m_ctxGeneric  any /*  *DBContext */
}

// Constructor of DBTableNoSql
func (_this *DBTableNoSql[T]) Constr(sqlName string, langName string, ctx *DBContextBaseNoSql) *DBTableNoSql[T] {
...
func (_this *DBTableNoSql[T]) cloneTable_GenModel() *DBTableNoSql[atomicsql.IGeneric_MODEL] {

	var table = (new(DBTableNoSql[atomicsql.IGeneric_MODEL])).Constr(_this.m_sqlName, _this.m_langName, _this.m_ctx)
...
func (_this *DBTableNoSql[T]) DeatachModel(model *T) {
...
// Do a clone of a DBTableNoSql
func (_this *DBTableNoSql[T]) CloneGenericModel() *DBTableNoSql[atomicsql.IGeneric_MODEL] {

	var newInst = new(DBTableNoSql[atomicsql.IGeneric_MODEL])
...
// Qry( tag ) - each DBTableNoSql can start a query sequence (DBQuery) usign Qry() method,
//
...
func (_this *DBTableNoSql[T]) Qry(tagID string) *DBQueryNoSql[T] {
	return _this.QryS(tagID, nil)
}

// QryS( tag, query ) - identical as Qry(tag), but is using only in lit func of WhereSubQ() and SelectSubQ()
//
func (_this *DBTableNoSql[T]) QryS(tagID string, containerQuery atomicsql.IDBQuery) *DBQueryNoSql[T] {
	...
	//var this1 = _this.(*DBTableNoSql[models.IGeneric_MODEL, models.IGeneric_MODEL])
	query := (new(DBQueryNoSql[T])).Constr(_this)
...
func (_this *DBQueryNoSql[T]) finishSubQuery(sqlQuery string) bool {
...
func (_this *DBTableNoSql[T]) getSchemaTable() string {
	return _this.m_schemaTable
}

func (_this *DBTableNoSql[T]) getSqlName() string {
	return _this.m_sqlName
}
func (_this *DBTableNoSql[T]) getLangName() string {
	return _this.m_langName
}

/*#PHPARG=[ T ];*/
func (_this *DBTableNoSql[T]) getModel2( /*#HashMap<Object>*/ args map[string]any) *T {
